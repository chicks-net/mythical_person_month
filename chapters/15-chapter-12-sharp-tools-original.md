...
system, who put this copy into a system integration sublibrary.
Now the original programmer could not change it, except by permission of the integration manager. As the system came together, the latter
...
ones diminish but do not vanish. Thus one needs dumps, sourcefile editors, snapshot dumps, even traces.
...
What high-level language should one use for system programming? The only reasonable candidate today is PL/I.[^6] It has a very
...
an interactive facility at least doubles productivity in system programming.[^8]
...
[^1]: The discussion of this chapter owes much to the work of E. E. David and A. L. Pugh of Bell Telephone Laboratories, F. J. Corbato of MIT, and N. H. Andahl and J. L. Letwin of IBM.

[^2]: A. L. Pugh of Bell Telephone Laboratories, private communication; L. Belady of IBM, private communication; M. V. Wilkes, "The Outer and Inner Syntax of a Programming Language," Comp. J., 11, 3 (Nov., 1968), pp. 260-263; D. L. Parnas, "Information Distribution Aspects of Design Methodology," Proc. IFIP Congress 71. Amsterdam: North-Holland, 1971.

[^3]: G. Mealy, Bell Telephone Laboratories, offers his experience in detailed private communication.

[^4]: F. J. Corbato of MIT, in "PL/I as a Tool for System Programming," Datamation, 15, 5 (May, 1969), pp. 68-76, gives a very useful treatment.

[^5]: I. D. Hill, "Wouldn't it be nice if we could write computer programs in ordinary English—or would it?" Comp. Bull., 16, 6 (June, 1972), pp. 306-312.

[^6]: IBM has announced that PL/I is to be the standard language for OS/360. D. M. Ritchie and K. L. Thompson, "The Unix Time-Sharing System," CACM, 17, 7 (July, 1974), pp. 365-375, argue persuasively for the suitability of C, a higher-level language of their devising.

[^7]: F. J. Corbato, loc. cit.

[^8]: J. Harr of Bell Telephone Laboratories, private communication.
