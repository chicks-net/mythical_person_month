...
some such communication is necessary; memory will fail the author-user, and he will require refreshing on the details of his
handiwork.
...
our own teaching. We typically attempt to maintain a machinereadable form of a program and an independent set of humanreadable documentation, consisting of prose and flow charts.
...
4. Refer to standard literature to document basic algorithms
   ...
   knowledgeable reader to skip it with confidence that he understands you.
...
[^1]: H. H. Goldstine and J. von Neumann, "Planning and coding of problems for an electronic computing instrument," Report on the Mathematical and Logical Aspects of an Electronic Computing Instrument, Part 11, Vol. 1. Princeton: Institute for Advanced Study, 1947. Reprinted in Bell and Newell, Computer Structures. New York: McGraw-Hill, 1971.

[^2]: K. E. Iverson, A Programming Language. New York: Wiley, 1962.

[^3]: This program is taken from my article, "How do committees invent?" Datamation, 14, 5 (April, 1968), pp. 28-31, Copyright 1968, and is used here by permission of the publisher.
